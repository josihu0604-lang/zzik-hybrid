...
export function Badge({
  ...
  return (
    <span
      ...
      className={clsx(
        className,
        'inline-flex items-center gap-x-1.5 rounded-full px-1.5 py-0.5 text-sm/5 font-medium sm:text-xs/5 forced-colors:outline',
        colors[color]
      )}
    />
  );
...
export const BadgeButton = forwardRef(function BadgeButton(
  ...
  let classes = clsx(
    className,
    'group relative inline-flex rounded-full focus:not-data-focus:outline-hidden data-focus:outline-2 data-focus:outline-offset-2 data-focus:outline-flame-500'
  );
