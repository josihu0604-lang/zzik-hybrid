...
export interface Database {
  public: {
    Tables: {
      ...
      restaurant_queue_settings: {
        Row: {
          id: string;
          restaurant_id: string;
          is_enabled: boolean;
          max_queue_size: number;
          avg_wait_per_party: number;
      ...
      queue_entries: {
        Row: {
          ...
          estimated_seating_time: string | null;
          status: 'waiting' | 'called' | 'seated' | 'cancelled' | 'no_show' | 'expired';
      ...
      queue_history: {
        Row: {
          ...
          final_status: 'waiting' | 'called' | 'seated' | 'cancelled' | 'no_show' | 'expired';
          joined_at: string;
          completed_at: string;
      ...
      queue_notifications: {
        Row: {
          ...
          user_id: string | null;
          notification_type: 'joined' | 'position_update' | 'almost_ready' | 'ready' | 'reminder' | 'expired' | 'cancelled';
