  ...
  useEffect(() => {
    ...
    if (process.env.NODE_ENV === 'production') {
      Sentry.captureException(error, {
        tags: { component: 'SettingsErrorBoundary', page: 'settings' },
        level: 'error',
      });
    }
  }, [error]);
  ...
  return (
    <div className="min-h-screen bg-space-950 flex items-center justify-center p-4">
      ...
      >
        ...
        >
          <Settings className="w-8 h-8 text-flame-500" />
        </div>

        <h1 className="text-white text-xl font-bold mb-3">설정을 불러올 수 없습니다</h1>
